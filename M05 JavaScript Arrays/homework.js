...
function todosIguales(array) {
   ...
   return array.every((elem) => {return elem === element});
}
...
function mesesDelAño(array) {
   ...
   if(array.includes('Marzo')) arr.push('Marzo');
   else return 'No se encontraron los meses pedidos';
   if(array.includes('Noviembre')) arr.push('Noviembre');
   else return 'No se encontraron los meses pedidos';
   if(array.includes('Enero')) arr.push('Enero');
   else return 'No se encontraron los meses pedidos';
